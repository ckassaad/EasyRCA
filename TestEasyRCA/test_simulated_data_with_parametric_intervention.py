...
from TestEasyRCA.generate_data import generate_data_with_parametric_intervention
...
if __name__ == '__main__':
    ...
    for str_i in list_graphs_interventions:
        ...
        if nb_anomalous_data > 100:
            ...
            eps = 50
        # generator = GenerateDataSoft(graph)
        # data = generator.generate_data(n=nb_data, intervention="parameter", rootStartIntervention=anomaly_start,
        ...
        data = generate_data_with_parametric_intervention(graph, nb_data, secondInterventionNode=intervention,
        ...
        if method == "EasyRCA":
            ...
            if nx.is_directed_acyclic_graph(dag):
                ...
                print("There is a cyclic in the infered summary causal graph!!!!! No root cause detected by EasyRCA!")
                root_causes = []
        elif method == "WhyMDC":
            import pandas as pd
